 ...
 */
public class ComicListFragmentRefactor extends Fragment {
    ...
    public static ComicListFragmentRefactor newInstance(ComicCollection collection) {
        ComicListFragmentRefactor fragment = new ComicListFragmentRefactor();

        
        Bundle args = new Bundle();
        args.putParcelableArrayList("ComicList",collection.getComicList());
        fragment.setArguments(args);
        
        return fragment;
    }
    
    private void setComicList(ArrayList<Comic> comicList)
    {
        mComicList = comicList;
    }

    public ComicListFragmentRefactor() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mComicList = args.getParcelableArrayList("ComicList");
    ...
    private void loadComics() {
        ...
        mTotalComicCount = mComicList.size();
        mProgress = 0;
        ...
        {
            File file = new File(mComicList.get(i).getFilePath()+"/"+mComicList.get(i).getFileName());
            
            if (Utilities.isZipArchive(file))
            {
                zipsToExtract.put(i,mComicList.get(i));
            }
            else
            {
                rarsToExtract.put(i,mComicList.get(i));
            }
        }
    ...
    private void onLoadingFinished()
    {
        ...
        removeDoubleComics();
        //((DrawerActivity)getActivity()).removeOldComics(mComicList);
